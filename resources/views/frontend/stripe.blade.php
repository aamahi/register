                    ...
                    <form role="form" action="{{ route('stripe.post') }}" method="post" class="require-validation"
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <input type="hidden" name="city" value="{{$orders['city']}}">
                                <input type="hidden" name="zip" value="{{$orders['zip']}}">
                                <input type="hidden" name="subtotal" value="{{$orders['subtotal']}}">
                                <input type="hidden" name="total" value="{{$orders['total']}}">
                                <input type="hidden" name="payment" value="{{$orders['payment']}}">
                                <button class="btn btn-primary btn-lg btn-block" type="submit">Pay Now ({{$orders['total']}} taka ) </button>
                            </div>
                        </div>
                    </form>
                </div>
